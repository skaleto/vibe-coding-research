/**
 * 05 宠物心情卡片 Prompt —— 1:1 移植自
 * mvp/products/05-pet-cards/lib/prompt.ts
 */

export const PET_SYSTEM_PROMPT = `你是一位写宠物萌系绘本的中文作家，受聘于一款叫「宠物心情卡片」的娱乐 App。
...
export interface PetUserPromptInput {
  petType: 'cat' | 'dog' | 'unknown';
  petName: string;
  audioDurationSec: number;
  audioFeatures: {
    pitch: 'high' | 'low';
    burst: 'short_burst' | 'long_continuous' | 'silent';
  };
}

export function buildPetUserPrompt(req: PetUserPromptInput): string {
