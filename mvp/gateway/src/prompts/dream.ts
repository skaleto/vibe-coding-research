/**
 * 04 梦境日记 Prompt —— 1:1 移植自
 * mvp/products/04-dream-journal/lib/prompts.ts
 */

import type { School } from '../mocks/dream';
...
export function buildDreamSystemPrompt(school: School): string {
