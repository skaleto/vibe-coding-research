/**
 * 04 梦境 mock 数据 —— 1:1 移植自
 * mvp/products/04-dream-journal/lib/mockAnalysis.ts
 */

import { DISCLAIMER_TOP, NEXT_STEP_DEFAULT } from '../lib/detectCrisis';
...
export function buildSupportiveMockAnalysis(school: School, level: 2 | 3): DreamAnalysis {
