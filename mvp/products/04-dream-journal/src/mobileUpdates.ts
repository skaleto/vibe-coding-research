...
const LAST_CHECK_AT_KEY = `dream-journal.${__APP_ID__}.mobile-update-last-check-at`;
const CHECK_INTERVAL_MS = 60 * 1000;
export const MOBILE_UPDATE_NOTICE_EVENT = `dream-journal.${__APP_ID__}.mobile-update-notice`;
